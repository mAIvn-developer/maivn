...
from maivn._internal.api.agent.client_cache import get_or_create_client
...
def test_agent_client_cache_key_varies_across_configuration_contexts() -> None:
    ...
    with temporary_configuration(config_a):
        client_a1 = get_or_create_client("k")
        client_a2 = get_or_create_client("k")

    with temporary_configuration(config_b):
        client_b1 = get_or_create_client("k")
