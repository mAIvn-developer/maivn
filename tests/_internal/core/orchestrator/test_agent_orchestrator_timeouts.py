...
class _StubAgentWithClientHttpTimeout:
    client: _StubClientWithHttpTimeout = _StubClientWithHttpTimeout()
    api_key: str | None = None
    timeout: float | None = None
    max_results: int | None = None
    name: str = "stub"
...
class _StubAgentWithClientExecutionTimeout:
    client: _StubClientWithExecutionTimeout = _StubClientWithExecutionTimeout()
    api_key: str | None = None
    timeout: float | None = None
    max_results: int | None = None
    name: str = "stub"
...
def test_agent_orchestrator_http_timeout_does_not_affect_execution_timeout() -> None:
    ...
    with patch(
        ...
        orchestrator = AgentOrchestrator(
            cast(Agent, cast(object, _StubAgent())),
            http_timeout=30.0,
            logger=None,
        )
...
def test_agent_orchestrator_uses_client_http_timeout_independently() -> None:
    ...
    with patch(
        ...
        orchestrator = AgentOrchestrator(
            cast(Agent, cast(object, _StubAgentWithClientHttpTimeout())),
            logger=None,
        )
...
def test_agent_orchestrator_uses_client_execution_timeout() -> None:
    ...
    with patch(
        ...
        orchestrator = AgentOrchestrator(
            cast(Agent, cast(object, _StubAgentWithClientExecutionTimeout())),
            logger=None,
        )
