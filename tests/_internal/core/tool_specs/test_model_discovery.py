...
def test_find_via_module_attrs() -> None:
    ...
    setattr(fake_module, "renamed_alpha", Alpha)  # noqa: B010 - synthetic module attr injection
...
def test_find_in_module_attrs_no_match() -> None:
    ...
    setattr(fake_module, "some_thing", Beta)  # noqa: B010 - synthetic module attr injection
...
def test_find_in_package_searches_sibling_submodules() -> None:
    ...
    setattr(fake_sub_b, "Alpha", Alpha)  # noqa: B010 - synthetic module attr injection
...
def test_find_in_package_skips_non_model_attrs() -> None:
    ...
    setattr(fake_sub, "Target", NotAModel)  # noqa: B010 - synthetic module attr injection
